  ...
  return (
    <section className="home-block" aria-labelledby="home-time-title">
      ...
      <figure className="tl-figure">
        ...
        {/* Bảng số cho trình đọc màn hình: hình cột không đọc được, bảng thì đọc
            được. Bảng bọc trong khối `sr-only` thay vì tự mang lớp đó: bảng không
            nhận `overflow: hidden`, nên một bảng ẩn vẫn đẩy bề ngang trang ra. */}
