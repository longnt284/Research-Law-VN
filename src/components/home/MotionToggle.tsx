 ...
 *
 * Dải văn bản ở trang chủ chạy liên tục, và một nội dung tự chuyển động quá năm
 * giây phải có cách dừng lại (WCAG 2.2.2). Lựa chọn ghi lên thẻ <html> dưới
 * dạng `data-motion="off"`, nên cùng một luật CSS dừng được dải xích, lớp nền ở
 * đầu các trang và sợi đồng ở thanh điều hướng. Lựa chọn được nhớ trong
 * `localStorage` và đoạn script ở đầu <body> đọc lại trước khung hình đầu tiên,
 * để người đã dừng không phải thấy dải chạy một nhịp rồi mới đứng.
 */
