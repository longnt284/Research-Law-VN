  ...
  vi: [
    ...
    },
    {
      ...
      p: [
        ...
        "Đợt bổ sung ngày 21 tháng 9 năm 2026 gồm hai mươi lăm văn bản được tra trong đúng điều kiện đó: các trang nguồn gốc vẫn bị chặn, nên mỗi bản ghi được đối chiếu giữa ít nhất hai kết quả tìm kiếm độc lập và cũng mang cảnh báo cần kiểm thêm. Từ đợt này, ngày tra cứu được ghi ở từng bản ghi thay vì một ngày chung cho cả kho: một bản ghi tra tháng trước không trở nên mới hơn vì có bản ghi khác vừa được tra hôm nay.",
    ...
    },
    {
      ...
      p: [
        ...
        "Lớp thứ năm là chuỗi văn bản. Một cặp chỉ thấy hai mắt xích, trong khi một hợp đồng thường sống qua cả đời văn bản: luật gốc, vài lần sửa đổi, rồi một luật thay thế. Chuỗi dựng từ cùng dữ liệu quan hệ ấy — các lần thay thế nối nhau thành trục, các lần sửa đổi treo vào đúng mắt xích mà chúng chạm tới — rồi đặt tất cả lên một dòng thời gian và một bảng dữ kiện nhiều cột, mỗi cột một đời văn bản. Chuỗi chỉ có hai văn bản thì trang cặp đã nói đủ nên không có trang riêng.",
    ...
    },
    {
      ...
      p: [
        ...
        "Tập dữ liệu này không đầy đủ và không cố tỏ ra đầy đủ. Nó tập trung vào mười lĩnh vực và chỉ chọn những văn bản trụ cột cùng quan hệ giữa chúng. Rất nhiều thông tư chuyên ngành, quyết định của Thủ tướng và văn bản địa phương không có mặt ở đây. Bản đồ này giúp định vị, không thay thế việc tra cứu đầy đủ.",
  ...
  en: [
    ...
    },
    {
      ...
      p: [
        ...
        "The batch added on 21 September 2026 — twenty-five instruments — was compiled under exactly those conditions: the primary sources were still blocked, so each record was corroborated across at least two independent search results and likewise carries the needs-checking flag. From this batch onward the date of search is recorded on each entry rather than once for the whole store: an entry checked last month does not become fresher because another was checked today.",
    ...
    },
    {
      ...
      p: [
        ...
        "The fifth layer is the lineage. A pair shows two links of the chain, while a contract commonly lives through a whole line of instruments: a parent statute, a few amendments, then a replacement. The lineage is built from the same relations — replacements strung into a spine, amendments hanging from the link they touch — and set out on one timeline and one many-column table of facts, a column to each generation. A lineage of two needs no page of its own, since the pair page already says all of it.",
