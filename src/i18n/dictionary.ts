  ...
  vi: {
    ...
    compare: {
      ...
      how: [
        ...
        "Điểm đối chiếu nội dung do người biên soạn viết, mỗi vế phải dẫn được bản ghi mình đọc ra.",
  ...
  en: {
    ...
    compare: {
      ...
      how: [
        ...
        "Content comparison points are written by an editor, and each side must cite the record it was read from.",
